...
public:	
	...
	UFUNCTION()
	bool InitBuilder(class UProductionSiteManager* _manager, class AMarketManager* marketManager, class APlayerBase* _builderOwner, class AWorkerWorldManager* _workerWorldManager);
